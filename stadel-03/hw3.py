...
Original file is located at
    https://colab.research.google.com/drive/1k7BFPU9D2gM17tX48L57Qi-Bf1qVt6S4
"""
...
for i in range(100):
  ...
  bestmse = 100000
  N = len(ytrue)
  for k in np.arange(1, 2*np.floor((N*.9+1)/2), 2):
#   print(k)
    mse = []
